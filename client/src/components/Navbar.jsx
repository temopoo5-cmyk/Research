  ...
  const rightSide = token ? (
    <div className="flex items-center gap-2">
      <div className="hidden sm:flex items-center gap-2.5">
        <div className="h-8 w-8 rounded-full gradient-btn flex items-center justify-center text-xs font-bold">
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#23CE6B]/20 bg-[#0A2B1C]/90 backdrop-blur-md shadow-sm shadow-[#23CE6B]/10">
      <div className="mx-auto max-w-7xl flex h-16 items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <button onClick={() => setOpen(!open)} className="xl:hidden rounded-lg p-2 text-[#EAFBF1] hover:bg-[#23CE6B]/20">
          ...
          <div className="border-t border-[#23CE6B]/20 pt-3">
            {token ? (
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" className="border-[#23CE6B]/30 text-red-400 hover:bg-red-500/10" onClick={handleLogout}>
