...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-16 overflow-hidden border-t border-[#4F6D7A]/20 bg-white/70 backdrop-blur">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {links.map(l => (
                <li key={l.to}>
                  <button onClick={() => navigate(l.to)} className="text-sm text-foreground/80 hover:text-[#243010] transition-colors">
                    {l.label}
                  </button>
                </li>
              ))}
        ...
        <div className="mt-8 pt-5 border-t border-[#4F6D7A]/20 text-center text-xs text-muted-foreground">
