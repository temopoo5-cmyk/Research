...
const bookPositions = [
  { icon: BookOpen, top: '8%', left: '3%', size: 'h-10 w-10', color: 'text-[#12854A]/35', dur: '9s', delay: '0s', tilt: '-8deg' },
  { icon: Book, top: '66%', left: '6%', size: 'h-14 w-14', color: 'text-[#12854A]/20', dur: '11.5s', delay: '1.2s', tilt: '6deg' },
  { icon: BookMarked, top: '20%', left: '88%', size: 'h-11 w-11', color: 'text-[#12854A]/35', dur: '10s', delay: '0.6s', tilt: '-4deg' },
  { icon: Library, top: '76%', left: '86%', size: 'h-12 w-12', color: 'text-[#12854A]/20', dur: '12s', delay: '2.1s', tilt: '9deg' },
  { icon: Book, top: '42%', left: '93%', size: 'h-10 w-10', color: 'text-[#12854A]/35', dur: '9.5s', delay: '1.7s', tilt: '-10deg' },
  { icon: Feather, top: '50%', left: '2%', size: 'h-8 w-8', color: 'text-[#12854A]/20', dur: '8.5s', delay: '2.6s', tilt: '-6deg' },
];
    ...
    <div className="relative hidden lg:block" aria-hidden="true">
      ...
      <div className="relative">
        ...
        <div className="rounded-3xl rounded-br-lg bg-gradient-to-br from-[#0A2B1C] to-[#123F29] p-5 text-[#EAFBF1] shadow-[8px_8px_0_0_rgba(35,206,107,0.55)] ring-1 ring-white/10">
          ...
          <div className="mt-3 flex items-center gap-1.5 text-[10px] text-[#9FEBBF]">
