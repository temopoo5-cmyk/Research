  ...
  return (
    <>
      <span className="code-tag sticker-mint bg-[#23CE6B]/20 text-[#12854A] inline-flex items-center gap-1.5">
        <Lock className="h-3 w-3" /> Abstract blurred
      </span>
    ...
    return (
      <div className="abstract-lock rounded-xl border border-border bg-white/60 p-3.5">
        <div className="flex items-start gap-1.5">
          ...
          <p className="text-xs italic leading-relaxed text-muted-foreground line-clamp-3 abstract-lock-text">{text}</p>
        </div>
        <div className="abstract-lock-veil" aria-hidden="true" />
  ...
  return (
    <div className="abstract-lock rounded-2xl rounded-br-sm border border-border bg-white/70 p-5 sm:p-6 overflow-hidden">
      ...
      <div className="flex items-start gap-1.5">
        ...
        <p className="text-sm sm:text-[15px] italic leading-relaxed text-muted-foreground font-display abstract-lock-text">
          {text}
        </p>
      </div>
      <div className="abstract-lock-veil" aria-hidden="true" />
